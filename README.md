...
> 🔐 **Windows installer code signing** is provided free of charge by the
> [SignPath Foundation](https://signpath.org/), a non-profit foundation that
> supports the open-source ecosystem with code signing certificates and the
> [SignPath.io](https://signpath.io) signing service.
